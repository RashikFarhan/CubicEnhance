document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!document.getElementById('wa-widget')) {
        ...
        waLink.className = 'w-[56px] h-[56px] flex items-center justify-center transition-all duration-300 transform hover:-translate-y-1 hover:scale-110 pointer-events-auto relative group';
        waLink.innerHTML = `
