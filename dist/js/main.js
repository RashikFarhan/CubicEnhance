document.addEventListener('DOMContentLoaded', () => {
    ...
    const previewData = {
        'sol-data-acct': `
            <img src="https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&w=800&q=80" class="w-full h-[220px] object-cover rounded-xl mb-6 shadow-sm" alt="Data & Internal Accounting">
        ...
        `,
        'sol-docs-back': `
            <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&q=80" class="w-full h-[220px] object-cover rounded-xl mb-6 shadow-sm" alt="Documentation & Back-Office Operations">
        ...
        `,
        'sol-ai-auto': `
            <img src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=800&q=80" class="w-full h-[220px] object-cover rounded-xl mb-6 shadow-sm" alt="AI Workflow & Automation">
        ...
        `,
        'sol-social-mkt': `
            <img src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?auto=format&fit=crop&w=800&q=80" class="w-full h-[220px] object-cover rounded-xl mb-6 shadow-sm" alt="Social Media Management & Marketing">
        ...
        `,
        'sol-web-design': `
            <img src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&w=800&q=80" class="w-full h-[220px] object-cover rounded-xl mb-6 shadow-sm" alt="Website Design & Maintenance">
        ...
        `,
        'sol-media-prod': `
            <img src="https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?auto=format&fit=crop&w=800&q=80" class="w-full h-[220px] object-cover rounded-xl mb-6 shadow-sm" alt="Photos & Videos Production/Editing">
    ...
    function bindLevel2Links() {
        ...
        l2Links.forEach(link => {
            link.addEventListener('click', (e) => {
                ...
                // On mobile or on second click of an already active link, navigate directly
                ...
                // Active state styling for middle column links
                l2Links.forEach(l => {
            ...
            // Double click to navigate as shortcut
    ...
    level1Links.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            if (pane2Data[target]) {
                ...
                // Bind the newly injected sub-links
                bindLevel2Links();
                
                // Auto-click the first one so the preview pane isn't empty
